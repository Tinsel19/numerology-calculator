...
var oneCoolor = document.getElementById('oneColor');
var twoColor = document.getElementById('twoColor');
var threeColor = document.getElementById('threeColor');
var fourColor = document.getElementById('fourColor');
var fiveColor = document.getElementById('fiveColor');
var sixColor = document.getElementById('sixColor');
var sevenColor = document.getElementById('sevenColor');
var eightColor = document.getElementById('eightColor');
var nineColor = document.getElementById('nineColor');
...
if (fpinText === '1' || fpinText === '10/1' || fpinInt[fpinInt.length - 1] === '1') {
    ...
    variable = ((medNum.textContent).trim()).split('/');
    ...
    variable = ((msuhdNum.textContent).trim()).split('/');
    variable = variable[variable.length - 1] + '1%';
    percentList.push(variable.trim());
    ...
    variable = ((mpNum.textContent).trim()).split('/');
    variable = variable[variable.length - 1] + '1%';
    percentList.push(variable.trim());
    ...
    for(var i = 0; i< variable.length; i ++) {
        percentList.push(variable[i].trim() + '2%')
    };
    ...
    if (kdNum.textContent === 'None') {
        ...
        for(var i = 0; i< variable.length; i ++) {
            ...
            if (variate === '' || variate === ' ') {
                ...
                percentList.push(variate.trim() + '2%')
            }
    ...
    var five, fiveAdd = 0;
    var six, sixAdd = 0;
    var seven, sevenAdd = 0;
    var eight, eightAdd = 0;
    var nine, nineAdd = 0;
    // one percent 
    for (var i = 0; i< percentList.length; i++) {
        any = percentList[i]
        if (any[0] === '1') {
            one  = Number(any.slice(1, -1));
            oneAdd+= one;
        } else if (any[0] === '2') {
            two  = Number(any.slice(1, -1));
            twoAdd+= two;
        } else if (any[0] === '3') {
            three  = Number(any.slice(1, -1));
            threeAdd+= three;
        } else if (any[0] === '4') {
            four  = Number(any.slice(1, -1));
            fourAdd+= four;
        } else if (any[0] === '5') {
            five  = Number(any.slice(1, -1));
            fiveAdd+= five;
        } else if (any[0] === '6') {
            six  = Number(any.slice(1, -1));
            sixAdd+= six;
        } else if (any[0] === '7') {
            seven  = Number(any.slice(1, -1));
            sevenAdd+= seven;
        } else if (any[0] === '8') {
            eight  = Number(any.slice(1, -1));
            eightAdd+= eight;
        } else if (any[0] === '9') {
            nine  = Number(any.slice(1, -1));
            nineAdd+= nine;
        }
